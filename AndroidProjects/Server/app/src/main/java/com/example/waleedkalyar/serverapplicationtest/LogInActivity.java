...
public class LogInActivity extends AppCompatActivity {
    ...
    public void chackForLogIn(final String eMail, final String password) {
        StringRequest mStringRequest = new StringRequest(1, getApplicationContext().getResources().getString(R.string.chack_user_login_url), new Response.Listener<String>() {
            @Override
