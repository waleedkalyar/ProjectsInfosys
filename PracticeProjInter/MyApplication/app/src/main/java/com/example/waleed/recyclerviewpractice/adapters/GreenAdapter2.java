package com.example.waleed.recyclerviewpractice.adapters;
...
import com.example.waleed.recyclerviewpractice.R;
import com.example.waleed.recyclerviewpractice.utiles.ColorUtils;
...
public class GreenAdapter2 extends RecyclerView.Adapter<GreenAdapter2.NumberViewHolder> {
    ...
    private static final String TAG = GreenAdapter2.class.getSimpleName();
     ...
     */
    public GreenAdapter2(int numberOfItems, ListItemClickListener listener) {
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder
         ...
         *                 {@link GreenAdapter2#onCreateViewHolder(ViewGroup, int)}
         */
